...
export default function UIContent({ onAddToCart, onVariantChange, onSwipeVariant, variantIndex = 0 }: UIContentProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <section id="aero-section" className="scroll-section" style={{ minHeight: '280vh' }}>
      ...
      <section id="grip-section" className="scroll-section" style={{ minHeight: '280vh' }}>
        <div className="sticky-content">
        <div className="grid md:grid-cols-2 gap-16 items-center w-full">
      ...
      <section id="product-section" className="scroll-section text-center bg-transparent" style={{ minHeight: '280vh' }}>
        <div className="sticky-content flex flex-col items-center justify-center">
          ...
          <div className="relative w-48 h-48 md:w-56 md:h-56 flex items-center justify-center my-2">
            {/* Pedestal glow */}
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[60%] h-16 bg-accent/[0.06] blur-2xl rounded-full" />
            {/* Subtle arc lines */}
