...
export default function UIContent({ onAddToCart, onVariantChange, onSwipeVariant, variantIndex = 0 }: UIContentProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <section id="aero-section" className="scroll-section scroll-section-feature" style={{ minHeight: '320vh' }}>
      ...
      <section id="grip-section" className="scroll-section scroll-section-feature" style={{ minHeight: '320vh' }}>
        <div className="sticky-content">
        <div className="grid md:grid-cols-2 gap-16 items-center w-full">
